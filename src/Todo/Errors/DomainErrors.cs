...
public static class DomainErrors
{
    ...
    public static class User
    {
        public static Error NotFound =>
            new Error("User.NotFound", "The user with the specified identifier was not found.");
        ...
        public static Error DuplicateEmail =>
            new Error("User.DuplicateEmail", "The specified email is already in use.");
    ...
    {
        public static Error NotFound =>
            new Error("Attendee.NotFound", "The attendee with the specified identifier was not found.");

        public static Error AlreadyProcessed =>
            new Error("Attendee.AlreadyProcessed", "The attendee has already been processed.");
    }
    ...
    {
        public static Error NotFound =>
            new Error("Category.NotFound", "The category with the specified identifier was not found.");
    }
    ...
    public static class Event
    {
        public static Error AlreadyCancelled =>
            new Error("Event.AlreadyCancelled", "The event has already been cancelled.");
    ...
    public static class PersonalEvent
    {
        ...
        public static Error AlreadyProcessed =>
            new Error("PersonalEvent.AlreadyProcessed", "The event has already been processed.");
    }
    ...
    public static class Notification
    {
        public static Error AlreadySent =>
            new Error("Notification.AlreadySent", "The notification has already been sent.");
    }
    ...
    public static class Invitation
    {
        ...
        public static Error AlreadyAccepted =>
            new Error("Invitation.AlreadyAccepted", "The invitation has already been accepted.");

        public static Error AlreadyRejected =>
            new Error("Invitation.AlreadyRejected", "The invitation has already been rejected.");
    }
    ...
    public static class Name
    {
        ...
        public static Error LongerThanAllowed =>
            new Error("Name.LongerThanAllowed", "The name is longer than allowed.");
    }
    ...
    public static class FirstName
    {
        ...
        public static Error LongerThanAllowed =>
            new Error("FirstName.LongerThanAllowed", "The first name is longer than allowed.");
    }
    ...
    public static class LastName
    {
        ...
        public static Error LongerThanAllowed =>
            new Error("LastName.LongerThanAllowed", "The last name is longer than allowed.");
    }
    ...
    public static class Email
    {
        ...
        public static Error LongerThanAllowed =>
            new Error("Email.LongerThanAllowed", "The email is longer than allowed.");
